    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        MultiLayerConfiguration multiLayerConfiguration = new NeuralNetConfiguration.Builder()
                ...
                .layer(0, new ConvolutionLayer.Builder()
                        .nIn(depth)
                        .nOut(outputSize*2) //number of filters
...
//        Il faut avoir le dossier des lettres dans le dossier de l'utilisateur, C:/Users/user
        String path = System.getProperty("user.home") + "/ArabicLetters";
...
//      Sauvegarde du modele dans un fichier
    	ModelSerializer.writeModel(model, "arabicletters.model",true);
        ...
        System.out.println("------------------------ Confusion Matrix to CSV ------------------");
        System.out.println(evaluation.getConfusionMatrix().toCSV());
        writeUsingOutputStream(evaluation.getConfusionMatrix().toCSV(),"ConfusionMatrix.csv");

    }

    private static void writeUsingOutputStream(String data, String filePath) throws IOException {
